...
const Card4 = () => {
  return (
    ...
    <div className="card__avatar absolute top-1/2 transform -translate-y-1/2 w-28 h-28 bg-white rounded-full flex justify-center items-center">
    ...
    <div className="card__title mt-16 font-medium text-lg text-black">
      Atia Roksana
    </div>
    <div className="card__subtitle mt-2 font-normal text-base text-gray-600">
      Web Development
    </div>
    <div className="card__wrapper mt-auto flex justify-center items-center mb-3 space-x-2">
      <button className="card__btn border-2 border-black rounded-md font-semibold text-xs py-1 px-3 transition-colors hover:bg-black hover:text-white">
        Button
      </button>
      <button className="card__btn card__btn-solid bg-black text-white rounded-md font-semibold text-xs py-1 px-3 transition-colors hover:bg-white hover:text-black">
        Button
      </button>
    </div>
  </div>`} text={`Profile Card`}>
      <div className="flex items-center justify-center">
        <div className="card relative w-72 h-96 flex flex-col items-center rounded-lg bg-white shadow-md">
          <div className="card__img h-48 w-full">
