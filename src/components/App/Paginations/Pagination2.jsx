...
const Pagination2 = () => {
  return (
    <CodeBox stringCode={`<ul className="flex space-x-4 justify-center">
    ...
    <li className="flex items-center justify-center shrink-0 bg-[#1C372C]  border-2 border-[#1C372C] cursor-pointer text-base font-bold text-white w-10 h-10 rounded-full">
      1
    </li>
