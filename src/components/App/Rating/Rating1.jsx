...
const Rating1 = () => {
  return (
    <CodeBox stringCode={`<div className="flex justify-center rounded-lg w-auto space-x-1 lg:space-x-2">
    <button>
      <svg
  ...
  </div>`} text={`Heart Rating`} >
      <div className="flex justify-center rounded-lg w-auto space-x-1 lg:space-x-2">
        <button>
          <svg
            className="text-red-400 w-6 h-auto fill-current"
            xmlns="http://www.w3.org/2000/svg"
